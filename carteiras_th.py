...
# Carregar o CSV
df = pd.read_csv("Carteiras_TH_Recomendadas.csv", delimiter=",")
...
# Salvar em CSV
df.to_csv("Carteiras_Com_Valores_Ajustados_TH.csv", index=False, sep=';')

# Salvar em Excel com formatação
with pd.ExcelWriter("Carteiras_Com_Valores_Ajustados_TH.xlsx", engine="xlsxwriter") as writer:
